package com.example.journalist_media_manager_springboot.dto.journalist;

import java.util.Collection;

public class JournalistUpdateDto {
    ...
    private Collection<MediaNameDto> mediaCollection;
    ...
    public Collection<MediaNameDto> getMediaCollection() {
        return mediaCollection;
    }

    public void setMediaCollection(Collection<MediaNameDto> mediaCollection) {
